...
GM.Config.PocketBlacklist = {
	...
	["doorportal_base"] = true,
	["doorportal_fleamarkettomotel"] = true,
	["doorportal_industrialtosubs"] = true,
	["doorportal_moteltofleamarket"] = true,
	["doorportal_substoindustrial"] = true,
