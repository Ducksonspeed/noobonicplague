...
function meta:drawOwnableInfo()
        ...
        // Credit to Hunger Johnson, makes door ownership text look better.
        local owned = self:isKeysOwned() or doorTeams
        ...
        draw.DrawNonParsedText(table.concat(doorInfo, "\n"), "DoorFont", x , y + 1 , black, 1)
        draw.DrawNonParsedText(table.concat(doorInfo, "\n"), "DoorFont", x, y, (blocked or owned or doorGroup) and white or red, 1)
end
