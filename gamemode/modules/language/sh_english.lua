...
local my_language = {
	...
	warrant_ordered = "%s ordered a search warrant for %s.",
	...
	wanted_by_police_print = "%s has made %s wanted.",
	...
	hitman_no_suicide = "The hitman won't kill themselves.",
	hitman_no_self_order = "A hitman cannot order a hit for themselves.",
	...
	hitman_no_cp = "Civil Protection cannot place hits!",
	hitman_no_dead = "Cannot place hit on them because they are fucking dead!",
